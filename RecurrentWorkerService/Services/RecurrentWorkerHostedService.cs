...
internal class RecurrentWorkerHostedService : BackgroundService
{
	private readonly ILogger<RecurrentWorkerHostedService> _logger;
	...
	public RecurrentWorkerHostedService(
		ILogger<RecurrentWorkerHostedService> logger,
